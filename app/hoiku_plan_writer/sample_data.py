...
def sample_profile() -> NurseryProfile:
    return NurseryProfile(
        ...
        local_context="住宅地と公園、図書館が近く、散歩や地域交流に出かけやすい。",
        ...
        support_policy="見守りを基本にしつつ、必要な場面で言葉かけと環境調整を行う。",
        curriculum_focus="全体的な計画の重点である主体的な遊び、協同性、地域との関わりにつなげる。",
        assessment_policy="子どもの選択、友だちとの相談、環境への関わりを振り返りの観点にする。",
...
def sample_annual_input() -> AnnualPlanInput:
    return AnnualPlanInput(
        ...
        annual_events="入園進級の集い、夏まつり、運動会、生活発表会、就学に向かう活動",
        seasonal_context="春の安心づくり、夏の開放感、秋の協同性、冬のまとまり",
...
def sample_monthly_input() -> MonthlyPlanInput:
    return MonthlyPlanInput(
        ...
        previous_reflection="新年度の生活に慣れ、自分から遊びを選ぶ姿が増えた。友だちとのやり取りは保育者の仲立ちが必要な場面がある。",
